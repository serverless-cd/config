...
module.exports = {
  ...
  // 不验证登陆的路由
  EXCLUDE_AUTH_URL: ['/', '/api/auth/login', '/api/auth/signUp', '/api/common/init', '/api/common/webhookTriggered', '/api/auth/callback/github', '/api/auth/callback/gitee', '/api/auth/callback/auth'],
  // 运行 engine 的函数名称
